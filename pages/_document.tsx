...
const title = 'Omuk Dokan';
const desc = 'Omuk Dokan e-commerce developed with Next.JS. Developed by Ikbal Nayem';
const keywords = 'Omuk Dokan, Online Shop, E-commerce';
