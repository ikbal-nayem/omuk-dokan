					...
					{sliders.map((slider) => (
						<SwiperSlide key={slider.id}>
							<div className='hidden lg:block'>
								<Image layout='responsive' src={slider.image} width={1144} height={572} alt={'some name'} />
							</div>
							...
							<div className={slider.rightText ? styles.rightTextSection : styles.leftTextSection}>
